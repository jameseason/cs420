...
void Symbol_Table::install (string *id, string *env, expr_type t) {
...
void Symbol_Table::install_parm (string *id, string *env, expr_type t, int pos) {
...
// environment.  Returns garbage if parameter isn't found.
